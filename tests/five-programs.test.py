...
assert 'id="mobileExerciseSummary"' in html, 'narrow live mode must keep the current exercise visible'
...
assert "first-ride-live-v23" in service_worker, 'all-program audio and onboarding release must ship under a fresh service-worker cache'
